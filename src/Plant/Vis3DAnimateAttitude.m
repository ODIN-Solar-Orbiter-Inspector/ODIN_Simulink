function [] = Vis3DAnimateAttitude(q_data, nsample, st_title, figure_size, varargin)
...
Vis3DRotateSpacecraft(h_spacecraft,q_data(2:5,1),[0 0 0])
...
if figure_size==2
    ...
    set(gcf,'Position',[50 50 screensize(3)-100 screensize(4)-150]);
end

% Subsample data
q_data       = q_data(:,1:nsample:end);
t_ephemeris  = q_data(1,:);
...
for i=2:npts
    ...
    v        = q2dcm([-q_prev(1:3); q_prev(4)])*v;          % transform body referenced rotation vector into reference frame referenced vector
